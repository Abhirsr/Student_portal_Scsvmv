 ...
 export default function OnDutyRequestForm() {
   const [formData, setFormData] = useState({
     name: "",
     registerNumber: "",
     email: "",
     requestType: "On-Duty", // fixed value
     companyName: "",
     mentorName: "",
     inchargeEmail: "",
     noOfMonths: "",
   ...
   const handleSubmit = (e: React.FormEvent) => {
     ...
     alert("On-Duty Leave Request Submitted!");
   };
       ...
       <div className="w-full max-w-4xl py-10 px-12 rounded-lg border-2 border-blue-500 bg-white shadow-md">
         ...
         >
           ...
           <div className="flex flex-col gap-4">
             ...
             <label className="font-[600] text-blue-500">Event Name</label>
             <input
               type="text"
               name="companyName"
           ...
           <div className="flex flex-col gap-4">
             ...
             <label className="font-[600] text-blue-500">Event Type</label>
             <input
               type="text"
               name="mentorName"
