...
export default function InternshipRequestForm() {
  const [formData, setFormData] = useState({
    name: "",
    registerNumber: "",
    email: "",
    requestType: "Internship", // fixed value
    companyName: "",
    mentorName: "",
    inchargeEmail: "",
    noOfMonths: "",
      ...
      <div className="w-full max-w-4xl py-10 px-12 rounded-lg border-2 border-blue-500 bg-white shadow-md">
        ...
        >
          ...
          <div className="flex flex-col gap-4">
            ...
            <label className="font-[600] text-blue-500">Company Name</label>
            <input
              type="text"
              name="companyName"
            ...
            <label className="font-[600] text-blue-500">Incharge Email</label>
            <select
              name="inchargeEmail"
          ...
          <div className="flex flex-col gap-4">
            ...
            <label className="font-[600] text-blue-500">Mentor Name</label>
            <input
              type="text"
              name="mentorName"
            ...
            <label className="font-[600] text-blue-500">No of Months</label>
            <input
              type="number"
              name="noOfMonths"
