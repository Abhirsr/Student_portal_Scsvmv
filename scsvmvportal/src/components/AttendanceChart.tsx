...
interface DynamicAttendanceChartProps {
...
export default function AttendanceChart({
  ...
  const chartData = {
    ...
    datasets: [
      {
        data: dataSet.map(() => 1),
        backgroundColor: dataSet.map((d) => COLORS[d.status]),
        borderWidth: 2,
      },
    ],
  };
  ...
  return (
    <div className="flex gap-8 flex-col ">
      <h2 className="text-center font-bold text-2xl text-sky-700 mb-2">
