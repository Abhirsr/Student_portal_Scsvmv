...
const Header = ({ loggedIn }: { loggedIn: boolean }) => {
  return (
    <div className="w-full flex items-center justify-center text-white bg-[linear-gradient(90deg,#0369A1_20%,#00A8EB_50%,#00BFFF_65%,#0369A1_90%)] relative md:h-[100px] p-2">
      {loggedIn && (
